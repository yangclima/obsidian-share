...
$$
\sum\limits_{n=1}^\infty a\cdot r^{n-1} = \sum\limits_{n=0}^\infty a\cdot r^{n}
$$

Para as quais caso $|r| \leq 1$ a série converge e caso contrário ela diverge, além disso, o valor da soma dessa série é dado por:
...
Para as quais caso $p > 1$ a série converge e caso $p \leq 1$ ela diverge.
